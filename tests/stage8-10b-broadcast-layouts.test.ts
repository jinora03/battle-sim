...
describe('Stage 8.10B broadcast layouts', () => {
  it('defines viewport-independent 1080p landscape and vertical compositions', () => {
    ...
    expect(BROADCAST_LAYOUTS.landscape.arena.width / BROADCAST_LAYOUTS.landscape.width).toBeGreaterThan(0.63);
    expect(BROADCAST_LAYOUTS.vertical.arena.height).toBeGreaterThan(BROADCAST_LAYOUTS.vertical.arena.width);
