...
export const frostContent: FighterContentBundle = {
  ...
  primaryAttack: {
    ...
    cooldownTicks: 42, attackAngleDegrees: 112, visualScale: 2.05, visualMounts: [{ id: 'center', side: 'center' }], visualGrip: { hand: 'right', x: 0.1 }, movementAllowed: true, friendlyFire: false,
