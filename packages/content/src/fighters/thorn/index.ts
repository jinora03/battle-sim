...
export const thornContent: FighterContentBundle = {
  ...
  primaryAttack: {
    ...
    cooldownTicks: 35, attackAngleDegrees: 135, visualScale: 1.45, visualMounts: [{ id: 'center', side: 'center' }], visualGrip: { hand: 'right', x: 0.08 }, movementAllowed: true, friendlyFire: false,
