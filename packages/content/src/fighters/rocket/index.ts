...
export const rocketContent: FighterContentBundle = {
  ...
  primaryAttack: {
    ...
    cooldownTicks: 92, attackAngleDegrees: 18, visualScale: 1.42, muzzleOffsetScale: 2.02, movementAllowed: true, friendlyFire: false,
    visualId: 'guided-rocket-launcher', audioId: 'rocket-launch',
    projectile: { speed: 11.4, radius: 10, lifetimeTicks: 122, fuseTicks: 0, gravity: 0, bounce: 0, explosionRadius: 116, explosionDamage: 9.8, explosionImpulse: 15, homingStrength: 0.12, homingDelayTicks: 8, homingRange: 720, homingTurnRadians: 0.062, trailStyle: 'smoke' }
  },
  skillProjectiles: [
    {
      ...
      projectile: { speed: 13.4, radius: 8, lifetimeTicks: 105, fuseTicks: 0, gravity: 0, bounce: 0, explosionRadius: 92, explosionDamage: 5, explosionImpulse: 12, homingStrength: 0.12, homingDelayTicks: 9, homingRange: 700, homingTurnRadians: 0.062, trailStyle: 'smoke' }
    },
    {
      ...
      projectile: { speed: 10.5, radius: 10, lifetimeTicks: 152, fuseTicks: 0, gravity: 0, bounce: 0, explosionRadius: 132, explosionDamage: 8.8, explosionImpulse: 16, homingStrength: 0.105, homingDelayTicks: 18, homingRange: 780, homingTurnRadians: 0.05, trailStyle: 'smoke' }
    },
    {
      ...
      projectile: { speed: 11.1, radius: 6, lifetimeTicks: 180, fuseTicks: 0, gravity: 0, bounce: 0, explosionRadius: 72, explosionDamage: 4.8, explosionImpulse: 9, homingStrength: 0.17, homingDelayTicks: 24, homingRange: 900, homingTurnRadians: 0.072, trailStyle: 'smoke' }
    }
  ]
};
