...
export const mechContent: FighterContentBundle = {
  ...
  primaryAttack: {
    ...
    cooldownTicks: 50, attackAngleDegrees: 88, visualScale: 1.6, visualMounts: [{ id: 'center', side: 'center' }], visualGrip: { hand: 'right', x: 0.06 }, movementAllowed: false, friendlyFire: false,
