...
export const voidContent: FighterContentBundle = {
  ...
  primaryAttack: {
    ...
    cooldownTicks: 34, attackAngleDegrees: 138, visualScale: 1.9, visualMounts: [{ id: 'center', side: 'center' }], visualGrip: { hand: 'right', x: 0.08 }, movementAllowed: true, friendlyFire: false,
