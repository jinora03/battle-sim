...
export const bladeVanguardContent: FighterContentBundle = {
  ...
  primaryAttack: {
    ...
    range: 190, minRange: 12, damage: 15.5, knockback: 7.8, windupTicks: 8, activeTicks: 5, recoveryTicks: 10,
    cooldownTicks: 31, attackAngleDegrees: 102, visualScale: 1.55, visualMounts: [{ id: 'center', side: 'center' }],
