...
const weaponRecipes: Record<string, WeaponVfxRecipe> = {
  ...
  'automatic-rifle': { weaponId: 'automatic-rifle', trailShape: 'beam', trailColor: 0xffc66d, impactColor: 0xffe29a, residualShape: 'spark', groundMark: 'none', muzzleFlash: true },
